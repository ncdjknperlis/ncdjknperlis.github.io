...
const resourcesData = [
    ...
    // =========================================================================
    {
        ...
        desc: "Panduan visual interaktif untuk memahami klasifikasi bacaan tekanan darah (normal, pra-hipertensi, dan hipertensi) serta tindakan klinikal yang perlu diambil segera.",
    ...
    },
    {
        ...
        category: "infografik",
        program: "hpt",
        desc: "Penerangan saintifik ringkas mengenai mekanisme natrium dalam menahan takungan air di dalam badan, sekali gus meningkatkan beban kerja jantung dan tekanan vaskular.",
    ...
    },
    {
        ...
        category: "infografik",
        program: "hpt",
        desc: "Langkah-langkah preventif primer merangkumi modifikasi gaya hidup, amalan pemakanan DASH, pengurangan stres, serta aktiviti fizikal berkala untuk mengelakkan risiko penyakit kardiovaskular.",
    ...
    },
    {
        ...
        category: "infografik",
        program: "hpt",
        desc: "Tip praktikal dan alternatif masakan untuk mengehadkan pengambilan garam harian kepada satu sudu teh (5 gram) sahaja demi mengawal paras natrium optimum dalam tubuh.",
    ...
    },
    {
        ...
        category: "video",
        program: "hpt",
        desc: "Video kempen kesedaran khas bersempena sambutan global, menekankan kepentingan saringan awal, pengesanan awal, serta pematuhan rejim ubat hipertensi secara konsisten.",
    ...
    },
    {
        ...
        category: "infografik",
        program: "hpt",
        desc: "Visualisasi komplikasi jangka panjang akibat diet tinggi garam terhadap organ-organ penting seperti kerosakan buah pinggang, risiko strok, dan krisis serangan jantung.",
        imageUrl: "https://drive.google.com/thumbnail?sz=w600&id=.../view",
    ...
    },
    {
        ...
        category: "video",
        program: "hpt",
        desc: "Kapsul video tutorial ringkas mengenai teknik pemantauan tekanan darah kendiri (HBPM) yang betul di rumah menggunakan mesin sfigmomanometer digital.",
    ...
    {
        title: "Anda Tidak Berseorangan",
        category: "video",
        program: "mental",
        desc: "Anda tidak berseorangan. Dapatkan bantuan segera! Hubungi Talian HEAL 15555.",
        imageUrl: "https://drive.google.com/thumbnail?sz=w600&id=1fpQcJ9LKhjSXNAMZiXvllWEtcpnIDeY5",
        videoUrl: "https://drive.google.com/file/d/1fpQcJ9LKhjSXNAMZiXvllWEtcpnIDeY5/preview",
        badgeText: "Video",
        badgeColorClass: "text-rose-600 bg-rose-50",
        infoText: "Format: Video Drive"
    },
    {
        title: "MHPSS (Bahagian 1)",
        category: "video",
        program: "mental",
        desc: "Anda tidak berseorangan. Dapatkan bantuan segera! Hubungi Talian HEAL 15555.",
        imageUrl: "https://drive.google.com/thumbnail?sz=w600&id=16A2fb3Ssa6xKX2nZl-zIx3ToBx6fDdbZ",
        videoUrl: "https://drive.google.com/file/d/16A2fb3Ssa6xKX2nZl-zIx3ToBx6fDdbZ/preview",
        badgeText: "Video",
        badgeColorClass: "text-rose-600 bg-rose-50",
        infoText: "Format: Video Drive"
    },
    {
        title: "Pertolongan Cemas Psikologi (PFA) di Tempat Kerja",
        category: "video",
        program: "mental",
        desc: "Dalam kesibukan kita menjaga kesihatan pesakit, adakalanya rakan sekerja di sebelah kita juga sedang bergelut dengan tekanan emosi, beban kerja melampau, atau trauma. Psychological First Aid (PFA) hadir sebagai sistem sokongan awal untuk membantu rakan sekerja merasa lebih selamat dan tenang. Kita tidak perlu menjadi pakar psikologi untuk membantu. Kehadiran dan kesediaan kita untuk mendengar adalah talian hayat yang sangat bermakna buat mereka. Tonton video untuk panduan penuh!",
        imageUrl: "https://drive.google.com/thumbnail?sz=w600&id=12lmB1cWhOExzylsRa5iC1mlpVxY29ux9",
        videoUrl: "https://drive.google.com/file/d/12lmB1cWhOExzylsRa5iC1mlpVxY29ux9/preview",
        badgeText: "Video",
        badgeColorClass: "text-rose-600 bg-rose-50",
        infoText: "Format: Video Drive"
    },
    ...
    },
    {
        ...
        category: "video",
        program: "mental",
        desc: "Panduan interaktif dan latihan pernafasan relaksasi terkawal (Deep Breathing Exercise) untuk membantu mengurangkan gelombang panik dan meredakan keresahan makro.",
    ...
    // =========================================================================
    {
        title: "Clinical Practice Guidelines (CPG) Management of Type 2 Diabetes Mellitus (T2DM)",
        ...
        desc: "Dokumen berkenaan pengurusan pesakit Diabetis Mellitus Jenis 2 (Type 2 Diabetes Mellitus (T2DM)).",
        imageUrl: "https://drive.google.com/thumbnail?auto=format&fit=crop&w=600&q=80&id=1QhGaygUGyCo_fwKUqFYyDLEzs3zTexdg", // Gambar hiasan kad grid luar
    ...
    {
        title: "Rujukan Pantas Clinical Practice Guidelines (CPG) Management of Type 2 Diabetes Mellitus (T2DM)",
        category: "cpg",
        program: "diabetes",
        desc: "Ringkasan algoritma dan jadual rawatan pantas CPG T2DM untuk rujukan segera para pengamal perubatan dan petugas klinikal di kaunter rawatan utama.",
        imageUrl: "https://drive.google.com/thumbnail?auto=format&fit=crop&w=600&q=80&id=1a9UbXlYaEn1dz-GW_Kv_7fBwR6cD90f8",
    ...
    },
    {
        ...
        category: "cpg",
        program: "diabetes",
        desc: "Manual latihan pendidikan komprehensif bagi pendidik diabetes, merangkumi pengurusan pemakanan, kaunseling terapeutik, saringan penjagaan kaki, serta pematuhan terapi insulin.",
        imageUrl: "https://drive.google.com/thumbnail?auto=format&fit=crop&w=600&q=80&id=18YwYlZIGYuYcBmznAGDNpt27F5lea_0w",
    ...
    },
    {
        ...
        category: "cpg",
        program: "diabetes",
        desc: "Garis panduan saringan siasatan penunjuk kualiti klinikal (SIQ) bagi menilai standard pengurusan dan kualiti penjagaan pesakit kencing manis di fasiliti kesihatan primer.",
        imageUrl: "https://drive.google.com/thumbnail?auto=format&fit=crop&w=600&q=80&id=1IdvZ1YbkSQtsMEnTxXpXyljzdZquobjU",
    ...
    },
    {
        ...
        category: "cpg",
        program: "diabetes",
        desc: "Himpunan data statistik lokal, trend prevalensiti penyakit kencing manis terkini, serta mesej impak kempen intervensi kesihatan peringkat negeri Perlis.",
        imageUrl: "https://drive.google.com/thumbnail?auto=format&fit=crop&w=600&q=80&id=1NzIsicLXdglhfI7VsPG6aHPL-GBBCV2A",
    ...
    },
    {
        ...
        category: "cpg",
        program: "hpt",
        desc: "Garis panduan amalan klinikal rasmi edisi ke-5 bagi diagnosis, stratifikasi risiko kardiovaskular, serta pengurusan rawatan farmakologi bagi pesakit hipertensi.",
        imageUrl: "https://drive.google.com/thumbnail?auto=format&fit=crop&w=600&q=80&id=106rfF9KxDF9u61ypkjyWUTU5DKshbra3",
    ...
    },
    {
        ...
        category: "cpg",
        program: "hpt",
        desc: "Dokumen arkib rujukan klinikal CPG Hipertensi edisi ke-4 untuk semakan sejarah komparatif evolusi garis panduan ubat-ubatan vaskular KKM.",
        imageUrl: "https://drive.google.com/thumbnail?auto=format&fit=crop&w=600&q=80&id=1FIzk8IZBVQNS3KgaNwf7iUsuNPfeQ3fY",
    ...
    },
    {
        ...
        category: "cpg",
        program: "hpt",
        desc: "Carta alir pengurusan krisis tekanan darah tinggi, klasifikasi ubat antikrisis, serta rujukan pantas dos harian untuk kegunaan klinik kesihatan.",
        imageUrl: "https://drive.google.com/thumbnail?auto=format&fit=crop&w=600&q=80&id= EmefzUyxHh0FwdwRRsqkUD4RJgYrukh8",
    ...
    },
    {
        ...
        category: "cpg",
        program: "hpt",
        desc: "Ringkasan infografik bertulis mengenai bahaya tersembunyi hipertensi, statistik morbiditi tempatan, serta saringan pencegahan penyakit kronik.",
        imageUrl: "https://drive.google.com/thumbnail?auto=format&fit=crop&w=600&q=80&id=1bjiO-NCRef0iz6W-tHPqZWfm87GBc7vk",
    ...
    },
    {
        ...
        category: "cpg",
        program: "hpt",
        desc: "Dokumen fakta rasmi advokasi kesihatan mengenai perkaitan rapat antara pengambilan sodium industri dengan komplikasi strok dan kegagalan fungsi organ.",
        imageUrl: "https://drive.google.com/thumbnail?auto=format&fit=crop&w=600&q=80&id=1JKl1rN08aGEBXcyQqElt8Y5rbio0e_17",
    ...
    },
    {
        ...
        category: "cpg",
        program: "hpl",
        desc: "Buku garis panduan amalan klinikal edisi terkini untuk pengurusan dislipidemia, stratifikasi risiko sasaran kolesterol LDL, serta rejim terapi statin.",
        imageUrl: "https://drive.google.com/thumbnail?auto=format&fit=crop&w=600&q=80&id=1AjhI2W7zQ9gS8f2zJNaKSe00eLfJv2NH",
    ...
    },
    {
        ...
        category: "latihan",
        program: "diabetes",
        desc: "Modul modul panduan latihan khusus bagi pembantu pegawai perubatan dan jururawat untuk memantapkan sistem pengurusan kes diabetes di fasiliti primer.",
        imageUrl: "https://images.unsplash.com/photo-1586281380349-632531db7ed4?auto=format&fit=crop&w=600&q=80",
        imgUrl: "https://drive.google.com/file/d/1AjhI2W7zQ9gS8f2zJNaKSe00eLfJv2NH/preview",
        badgeText: "Modul Latihan",
    ...
    },
    {
        ...
        category: "cpg",
        program: "rokok",
        desc: "Buku panduan amalan pengurusan kesihatan klinikal rasmi bagi menangani, mendiagnosis, dan merawat kecederaan paru-paru akut (EVALI) akibat tabiat vaping.",
        imageUrl: "images/card/card-default.png",
    ...
    },
    {
        ...
        materials: [
            ...
            {
                name: "Infografik 2: Bertindak Sekarang: Gaya Hidup and Rawatan",
                type: "🎨 Poster",
    ...
    {
        title: "Siri Infografik Akta 852 - Orang Belum Dewasa (OBD)",
        category: "package",  // Mengekalkan kategori package supaya dikesan oleh enjin JS
        program: "akta852",  // Ditapis di bawah program Diabetes
        desc: "Koleksi infografik berkaitan definisi Orang Belum Dewasa (OBD) dan kesalahan sekiranya terdapat sebarang jual beli dan penggunaan produk merokok terhadap OBD.",
        imageUrl: "https://drive.google.com/thumbnail?sz=w600&id=11EVcswBudLHre0cStC8MLgqtteGKJC3B",
        badgeText: "Album Infografik", // Label tersuai untuk membezakannya dengan pakej video/fail biasa
        badgeColorClass: "text-purple-600 bg-purple-50", 
        infoText: "4 Siri Infografik",
        materials: [
            {
                name: "Infografik 1: Lindungi Generasi Muda Kita",
                type: "🎨 Poster",
                url: "https://drive.google.com/file/d/11EVcswBudLHre0cStC8MLgqtteGKJC3B/preview",
                thumb: "https://drive.google.com/thumbnail?sz=w100&id=11EVcswBudLHre0cStC8MLgqtteGKJC3B"
            },
            {
                name: "Infografik 2: Definisi dan Larangan Orang Belum Dewasa (OBD)",
                type: "🎨 Poster",
                url: "https://drive.google.com/file/d/1-dPDR1s3PUz29NqdATQaYKWXpJ9ZG9i-/preview",
                thumb: "https://drive.google.com/thumbnail?sz=w100&id=1-dPDR1s3PUz29NqdATQaYKWXpJ9ZG9i-"
            },
            {
                name: "Infografik 3: Tanggungjawab Penjual Produk Merokok",
                type: "🎨 Poster",
                url: "https://drive.google.com/file/d/1OqVhKvD8ILttAPne9ksdHyWFPbOZYQ8U/preview",
                thumb: "https://drive.google.com/thumbnail?sz=w100&id=1OqVhKvD8ILttAPne9ksdHyWFPbOZYQ8U"
            },
            {
                name: "Infografik 4: Selamatkan Generasi Muda Kita",
                type: "🎨 Poster",
                url: "https://drive.google.com/file/d/1MapwoBjaVBvKwiNKvu7RQxJO8sXdL48V/preview",
                thumb: "https://drive.google.com/thumbnail?sz=w100&id=1MapwoBjaVBvKwiNKvu7RQxJO8sXdL48V"
            }
        ]
    },
    {
